...
import ModalConfirmDeleteChat from "../../../components/modal/ModalConfirmDeleteChat";
const ChatDetail = ({ isInfoOpen, otherUserProfile, chatId }) => {
  const [isOpenModalConfirmDeleteChat, setIsOpenModalConfirmDeleteChat] =
    useState(false);
  return (
    <div
    ...
    >
      <div className="flex flex-col h-full">
        ...
        <div className=" py-4 flex flex-col justify-between flex-1">
          ...
          <div
            className="py-2 px-4"
            onClick={() => setIsOpenModalConfirmDeleteChat(true)}
          >
      ...
      {isOpenModalConfirmDeleteChat && (
        <ModalConfirmDeleteChat
          isOpenModalConfirmDeleteChat={isOpenModalConfirmDeleteChat}
          setIsOpenModalConfirmDeleteChat={setIsOpenModalConfirmDeleteChat}
          chatId={chatId}
        />
      )}
    </div>
