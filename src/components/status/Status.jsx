    ...
    <div className="flex-1 flex flex-col p-4 gap-y-4">
      ...
      <div className="flex flex-col">
        <div className="flex justify-between">
          ...
          <div onClick={() => setIsOpenSetting(!isOpenSetting)} className=" cursor-pointer">
            {isOpenSetting ? <MdKeyboardArrowUp className="text-3xl"/> :
          ...
          <div className="flex flex-col gap-y-3">
            <div className="flex justify-between items-center gap-x-2">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" className="sr-only peer"  onChange={handleHideLikes}/>
            ...
            <p className="text-color-btn-gray text-xs">
              ...
              đầu bài viết. Để ẩn số lượt thích trên bài viết của người khác,
              hãy đi đến phần cài đặt tài khoản.
            </p>
            <div className="flex justify-between items-center gap-x-2">
              <p>Tắt tính năng bình luận</p>
              <label className="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" className="sr-only peer" onChange={handleTurnOfComment}/>
                <div className="w-11 h-6 bg-gray-300 rounded-full peer-checked:bg-green-500 transition-colors duration-300"></div>
