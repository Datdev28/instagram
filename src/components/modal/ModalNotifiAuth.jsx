...
const ModalNote = ({ modalIsOpenNotifiAuth, setModalIsOpenNotifiAuth }) => {
        ...
        >
          <div className="w-full flex justify-end items-center">
            <span
              ...
              onClick={() => setModalIsOpenNotifiAuth(false)}
            >
              ✕
            </span>
          </div>
          <div className="flex flex-col w-full p-10 max-sm:p-0">
            <div className="w-full gap-y-2 flex flex-col">
              ...
              <p className="text-xs text-center">Là người đầu tiên xem được thông tin mới khi bạn theo dõi {userProfile.userName}.</p>
              ...
              <Link to="/auth">
               <button className="w-full bg-blue-400 py-2 rounded-xl mt-4 cursor-pointer">Đăng kí</button>
              </Link>
              <Link to="/auth">
