  ...
  return (
    <div>
      <Modal
        ...
        isOpen={isOpenModalSaveWithoutLogin}
        onRequestClose={() => setIsOpenModalSaveWithoutLogin(false)}
        style={{
          overlay: {
        ...
        >
          <div className="w-full flex justify-end items-center">
            <span
              ...
              onClick={() => {
                setIsOpenModalSaveWithoutLogin(false);
              }}
            >
              ✕
            </span>
          ...
          <div className="flex flex-col w-full p-10 max-sm:p-0">
            <div className="w-full gap-y-2 flex flex-col">
              ...
              <p className="text-md text-center">Hãy lưu bài viết của <span className="font-bold">{post?.byUserName}</span> để sau này dễ tìm</p>
...
export default ModalSaveWithoutLogin;
